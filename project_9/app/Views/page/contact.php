    ...
    <div class="row g-5 align-items-start">
        <div class="col-lg-6">
            ...
            <p class="mt-4 text-muted">
                ...
                dan artikel? Kami senang mendengar kabar dari Anda!
            </p>
            <ul class="list-unstyled fs-5 mt-4">
                <li><strong>Email:</strong> bukukita.ac.id</li>
                <li><strong>WhatsApp:</strong> +62 87723710329</li>
                <li><strong>Instagram:</strong> @bukita.id</li>
            </ul>
            <p class="mt-4 text-muted">
